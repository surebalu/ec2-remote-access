...
- **Terminal colour schemes and font**: Settings → Terminal offers Dracula, One Dark, Tokyo Night, Catppuccin Mocha, Nord, Gruvbox, Monokai, Solarized (dark/light), GitHub (dark/light) and One Light, plus any installed monospace font (Monaco by default) and size. Changes apply to open tabs immediately.
